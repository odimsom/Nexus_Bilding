...
public class CustomReportSelectionConfiguration : IEntityTypeConfiguration<CustomReportSelection>
{
    public void Configure(EntityTypeBuilder<CustomReportSelection> builder)
    {
        builder.ToTable("custom_report_selection", "administration");
        ...
        builder.Property(x => x.SendToEmail).HasColumnName("send_to_email");
