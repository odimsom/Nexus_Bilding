...
public class FiledServiceContractHeaderConfiguration : IEntityTypeConfiguration<FiledServiceContractHeader>
{
    public void Configure(EntityTypeBuilder<FiledServiceContractHeader> builder)
    {
        builder.ToTable("filed_service_contract_header", "administration");
        ...
        builder.Property(x => x.CalcdAnnualAmount).HasColumnName("calcd_annual_amount").HasPrecision(18, 5);
        ...
        builder.Property(x => x.FileDate).HasColumnName("file_date");
        builder.Property(x => x.FileTime).HasColumnName("file_time");
        builder.Property(x => x.FiledBy).HasColumnName("filed_by");
        builder.Property(x => x.ReasonForFiling).HasColumnName("reason_for_filing");
        builder.Property(x => x.ContractTypeRelation).HasColumnName("contract_type_relation");
        builder.Property(x => x.ContractNoRelation).HasColumnName("contract_no_relation");
