...
public class FinanceChargeMemoHeaderConfiguration : IEntityTypeConfiguration<FinanceChargeMemoHeader>
{
    public void Configure(EntityTypeBuilder<FinanceChargeMemoHeader> builder)
    {
        builder.ToTable("finance_charge_memo_header", "administration");
        ...
        builder.Property(x => x.IssuingNoSeries).HasColumnName("issuing_no_series");
        builder.Property(x => x.IssuingNo).HasColumnName("issuing_no");
