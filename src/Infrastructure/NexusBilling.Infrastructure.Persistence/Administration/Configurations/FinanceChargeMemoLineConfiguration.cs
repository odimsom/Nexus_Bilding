...
public class FinanceChargeMemoLineConfiguration : IEntityTypeConfiguration<FinanceChargeMemoLine>
{
    public void Configure(EntityTypeBuilder<FinanceChargeMemoLine> builder)
    {
        builder.ToTable("finance_charge_memo_line", "administration");
