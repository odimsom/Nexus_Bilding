...
public class MediaSetConfiguration : IEntityTypeConfiguration<MediaSet>
{
    public void Configure(EntityTypeBuilder<MediaSet> builder)
    {
        builder.ToTable("media_set", "administration");
