...
public class ServiceInvoiceHeaderConfiguration : IEntityTypeConfiguration<ServiceInvoiceHeader>
{
    public void Configure(EntityTypeBuilder<ServiceInvoiceHeader> builder)
    {
        builder.ToTable("service_invoice_header", "administration");
