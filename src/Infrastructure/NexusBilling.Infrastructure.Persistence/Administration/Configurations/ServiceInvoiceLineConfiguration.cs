...
public class ServiceInvoiceLineConfiguration : IEntityTypeConfiguration<ServiceInvoiceLine>
{
    public void Configure(EntityTypeBuilder<ServiceInvoiceLine> builder)
    {
        builder.ToTable("service_invoice_line", "administration");
        ...
        builder.Property(x => x.SubstitutionAvailable).HasColumnName("substitution_available");
