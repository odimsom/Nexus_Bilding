...
public class ServiceItemLineConfiguration : IEntityTypeConfiguration<ServiceItemLine>
{
    public void Configure(EntityTypeBuilder<ServiceItemLine> builder)
    {
        builder.ToTable("service_item_line", "administration");
        ...
        builder.Property(x => x.RepairStatusCode).HasColumnName("repair_status_code");
        ...
        builder.Property(x => x.ContractLineNo).HasColumnName("contract_line_no");
