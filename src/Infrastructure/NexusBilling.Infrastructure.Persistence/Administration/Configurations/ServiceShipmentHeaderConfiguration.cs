...
public class ServiceShipmentHeaderConfiguration : IEntityTypeConfiguration<ServiceShipmentHeader>
{
    public void Configure(EntityTypeBuilder<ServiceShipmentHeader> builder)
    {
        builder.ToTable("service_shipment_header", "administration");
