...
public class TransferHeaderConfiguration : IEntityTypeConfiguration<TransferHeader>
{
    public void Configure(EntityTypeBuilder<TransferHeader> builder)
    {
        builder.ToTable("transfer_header", "administration");
        ...
        builder.Property(x => x.LastShipmentNo).HasColumnName("last_shipment_no");
        builder.Property(x => x.LastReceiptNo).HasColumnName("last_receipt_no");
