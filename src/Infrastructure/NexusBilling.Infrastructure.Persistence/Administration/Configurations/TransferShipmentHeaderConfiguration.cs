...
public class TransferShipmentHeaderConfiguration : IEntityTypeConfiguration<TransferShipmentHeader>
{
    public void Configure(EntityTypeBuilder<TransferShipmentHeader> builder)
    {
        builder.ToTable("transfer_shipment_header", "administration");
