...
public class ItemApplicationEntryConfiguration : IEntityTypeConfiguration<ItemApplicationEntry>
{
    public void Configure(EntityTypeBuilder<ItemApplicationEntry> builder)
    {
        builder.ToTable("item_application_entry", "inventory");
        ...
        builder.Property(x => x.OutboundEntryIsUpdated).HasColumnName("outbound_entry_is_updated");
    }
}
