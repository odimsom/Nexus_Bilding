...
public class HandledIcInboxPurchHeaderConfiguration : IEntityTypeConfiguration<HandledIcInboxPurchHeader>
{
    public void Configure(EntityTypeBuilder<HandledIcInboxPurchHeader> builder)
    {
        builder.ToTable("handled_ic_inbox_purch_header", "purchasing");
