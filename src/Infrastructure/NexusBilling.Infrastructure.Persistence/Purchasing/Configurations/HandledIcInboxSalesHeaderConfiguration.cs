...
public class HandledIcInboxSalesHeaderConfiguration : IEntityTypeConfiguration<HandledIcInboxSalesHeader>
{
    public void Configure(EntityTypeBuilder<HandledIcInboxSalesHeader> builder)
    {
        builder.ToTable("handled_ic_inbox_sales_header", "purchasing");
