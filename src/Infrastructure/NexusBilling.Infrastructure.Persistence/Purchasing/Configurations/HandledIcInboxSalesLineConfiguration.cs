...
public class HandledIcInboxSalesLineConfiguration : IEntityTypeConfiguration<HandledIcInboxSalesLine>
{
    public void Configure(EntityTypeBuilder<HandledIcInboxSalesLine> builder)
    {
        builder.ToTable("handled_ic_inbox_sales_line", "purchasing");
        ...
        builder.Property(x => x.ItemRef).HasColumnName("item_ref");
