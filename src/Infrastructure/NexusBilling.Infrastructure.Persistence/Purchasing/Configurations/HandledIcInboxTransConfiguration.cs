...
public class HandledIcInboxTransConfiguration : IEntityTypeConfiguration<HandledIcInboxTrans>
{
    public void Configure(EntityTypeBuilder<HandledIcInboxTrans> builder)
    {
        builder.ToTable("handled_ic_inbox_trans", "purchasing");
