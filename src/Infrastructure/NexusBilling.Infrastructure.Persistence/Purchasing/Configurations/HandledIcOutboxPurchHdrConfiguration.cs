...
public class HandledIcOutboxPurchHdrConfiguration : IEntityTypeConfiguration<HandledIcOutboxPurchHdr>
{
    public void Configure(EntityTypeBuilder<HandledIcOutboxPurchHdr> builder)
    {
        builder.ToTable("handled_ic_outbox_purch_hdr", "purchasing");
