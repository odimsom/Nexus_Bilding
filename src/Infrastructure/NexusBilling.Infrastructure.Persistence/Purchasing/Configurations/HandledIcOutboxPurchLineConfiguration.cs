...
public class HandledIcOutboxPurchLineConfiguration : IEntityTypeConfiguration<HandledIcOutboxPurchLine>
{
    public void Configure(EntityTypeBuilder<HandledIcOutboxPurchLine> builder)
    {
        builder.ToTable("handled_ic_outbox_purch_line", "purchasing");
