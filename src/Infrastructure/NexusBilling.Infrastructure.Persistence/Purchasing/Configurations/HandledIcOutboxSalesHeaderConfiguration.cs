...
public class HandledIcOutboxSalesHeaderConfiguration : IEntityTypeConfiguration<HandledIcOutboxSalesHeader>
{
    public void Configure(EntityTypeBuilder<HandledIcOutboxSalesHeader> builder)
    {
        builder.ToTable("handled_ic_outbox_sales_header", "purchasing");
