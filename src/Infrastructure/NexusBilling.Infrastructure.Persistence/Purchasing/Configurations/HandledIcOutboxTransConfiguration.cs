...
public class HandledIcOutboxTransConfiguration : IEntityTypeConfiguration<HandledIcOutboxTrans>
{
    public void Configure(EntityTypeBuilder<HandledIcOutboxTrans> builder)
    {
        builder.ToTable("handled_ic_outbox_trans", "purchasing");
