...
public class IcInboxPurchaseLineConfiguration : IEntityTypeConfiguration<IcInboxPurchaseLine>
{
    public void Configure(EntityTypeBuilder<IcInboxPurchaseLine> builder)
    {
        builder.ToTable("ic_inbox_purchase_line", "purchasing");
