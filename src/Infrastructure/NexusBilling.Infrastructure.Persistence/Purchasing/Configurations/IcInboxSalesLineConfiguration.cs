...
public class IcInboxSalesLineConfiguration : IEntityTypeConfiguration<IcInboxSalesLine>
{
    public void Configure(EntityTypeBuilder<IcInboxSalesLine> builder)
    {
        builder.ToTable("ic_inbox_sales_line", "purchasing");
