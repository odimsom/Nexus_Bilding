...
public class IcInboxTransactionConfiguration : IEntityTypeConfiguration<IcInboxTransaction>
{
    public void Configure(EntityTypeBuilder<IcInboxTransaction> builder)
    {
        builder.ToTable("ic_inbox_transaction", "purchasing");
        ...
        builder.Property(x => x.OriginalDocumentNo).HasColumnName("original_document_no");
