...
public class IcOutboxPurchaseHeaderConfiguration : IEntityTypeConfiguration<IcOutboxPurchaseHeader>
{
    public void Configure(EntityTypeBuilder<IcOutboxPurchaseHeader> builder)
    {
        builder.ToTable("ic_outbox_purchase_header", "purchasing");
