...
public class IcOutboxPurchaseLineConfiguration : IEntityTypeConfiguration<IcOutboxPurchaseLine>
{
    public void Configure(EntityTypeBuilder<IcOutboxPurchaseLine> builder)
    {
        builder.ToTable("ic_outbox_purchase_line", "purchasing");
