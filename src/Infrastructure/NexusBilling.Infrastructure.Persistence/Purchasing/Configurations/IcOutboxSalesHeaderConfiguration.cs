...
public class IcOutboxSalesHeaderConfiguration : IEntityTypeConfiguration<IcOutboxSalesHeader>
{
    public void Configure(EntityTypeBuilder<IcOutboxSalesHeader> builder)
    {
        builder.ToTable("ic_outbox_sales_header", "purchasing");
