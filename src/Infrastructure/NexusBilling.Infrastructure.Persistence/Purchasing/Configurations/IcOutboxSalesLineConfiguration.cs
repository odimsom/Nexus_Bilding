...
public class IcOutboxSalesLineConfiguration : IEntityTypeConfiguration<IcOutboxSalesLine>
{
    public void Configure(EntityTypeBuilder<IcOutboxSalesLine> builder)
    {
        builder.ToTable("ic_outbox_sales_line", "purchasing");
