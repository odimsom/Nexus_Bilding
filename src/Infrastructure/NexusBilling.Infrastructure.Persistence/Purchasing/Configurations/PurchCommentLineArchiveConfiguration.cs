...
public class PurchCommentLineArchiveConfiguration : IEntityTypeConfiguration<PurchCommentLineArchive>
{
    public void Configure(EntityTypeBuilder<PurchCommentLineArchive> builder)
    {
        builder.ToTable("purch_comment_line_archive", "purchasing");
