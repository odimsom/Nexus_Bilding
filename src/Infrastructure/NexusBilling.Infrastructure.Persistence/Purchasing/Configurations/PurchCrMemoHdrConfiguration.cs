...
public class PurchCrMemoHdrConfiguration : IEntityTypeConfiguration<PurchCrMemoHdr>
{
    public void Configure(EntityTypeBuilder<PurchCrMemoHdr> builder)
    {
        builder.ToTable("purch_cr_memo_hdr", "purchasing");
        ...
        builder.Property(x => x.PrepaymentCreditMemo).HasColumnName("prepayment_credit_memo");
        builder.Property(x => x.PrepaymentOrderNo).HasColumnName("prepayment_order_no");
