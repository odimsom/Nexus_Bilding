...
public class PurchCrMemoLineConfiguration : IEntityTypeConfiguration<PurchCrMemoLine>
{
    public void Configure(EntityTypeBuilder<PurchCrMemoLine> builder)
    {
        builder.ToTable("purch_cr_memo_line", "purchasing");
