...
public class PurchInvHeaderConfiguration : IEntityTypeConfiguration<PurchInvHeader>
{
    public void Configure(EntityTypeBuilder<PurchInvHeader> builder)
    {
        builder.ToTable("purch_inv_header", "purchasing");
        ...
        builder.Property(x => x.PrepaymentInvoice).HasColumnName("prepayment_invoice");
