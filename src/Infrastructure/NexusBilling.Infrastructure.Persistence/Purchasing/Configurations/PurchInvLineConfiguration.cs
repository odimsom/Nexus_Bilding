...
public class PurchInvLineConfiguration : IEntityTypeConfiguration<PurchInvLine>
{
    public void Configure(EntityTypeBuilder<PurchInvLine> builder)
    {
        builder.ToTable("purch_inv_line", "purchasing");
