...
public class PurchRcptHeaderConfiguration : IEntityTypeConfiguration<PurchRcptHeader>
{
    public void Configure(EntityTypeBuilder<PurchRcptHeader> builder)
    {
        builder.ToTable("purch_rcpt_header", "purchasing");
