...
public class ReturnShipmentLineConfiguration : IEntityTypeConfiguration<ReturnShipmentLine>
{
    public void Configure(EntityTypeBuilder<ReturnShipmentLine> builder)
    {
        builder.ToTable("return_shipment_line", "purchasing");
