...
public class VendorLedgerEntryConfiguration : IEntityTypeConfiguration<VendorLedgerEntry>
{
    ...
    {
        builder.ToTable("vendor_ledger_entry", "purchasing");
        ...
        builder.Property(x => x.PurchaseLcy).HasColumnName("purchase_lcy");
        ...
        builder.Property(x => x.PmtDiscRcdLcy).HasColumnName("pmt_disc_rcd_lcy");
