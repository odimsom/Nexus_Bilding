...
namespace NexusBilling.Infrastructure.Persistence.Repositories.Base;

public class GenericRepository<TEntity>(NexusBillingDbContext dbContext) : IGenericRepository<TEntity> where TEntity : class
{
