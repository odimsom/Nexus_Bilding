...
public class JobJournalBatchConfiguration : IEntityTypeConfiguration<JobJournalBatch>
{
    public void Configure(EntityTypeBuilder<JobJournalBatch> builder)
    {
        builder.ToTable("job_journal_batch", "resources");
