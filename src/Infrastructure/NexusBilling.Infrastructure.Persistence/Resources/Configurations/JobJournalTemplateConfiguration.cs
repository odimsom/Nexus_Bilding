...
public class JobJournalTemplateConfiguration : IEntityTypeConfiguration<JobJournalTemplate>
{
    public void Configure(EntityTypeBuilder<JobJournalTemplate> builder)
    {
        builder.ToTable("job_journal_template", "resources");
