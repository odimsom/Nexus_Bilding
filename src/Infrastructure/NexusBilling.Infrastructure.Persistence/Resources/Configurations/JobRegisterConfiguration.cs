...
public class JobRegisterConfiguration : IEntityTypeConfiguration<JobRegister>
{
    public void Configure(EntityTypeBuilder<JobRegister> builder)
    {
        builder.ToTable("job_register", "resources");
