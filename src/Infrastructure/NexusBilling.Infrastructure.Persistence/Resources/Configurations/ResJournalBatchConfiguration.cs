...
public class ResJournalBatchConfiguration : IEntityTypeConfiguration<ResJournalBatch>
{
    public void Configure(EntityTypeBuilder<ResJournalBatch> builder)
    {
        builder.ToTable("res_journal_batch", "resources");
