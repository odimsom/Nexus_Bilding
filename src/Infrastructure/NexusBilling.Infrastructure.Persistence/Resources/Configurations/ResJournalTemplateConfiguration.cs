...
public class ResJournalTemplateConfiguration : IEntityTypeConfiguration<ResJournalTemplate>
{
    public void Configure(EntityTypeBuilder<ResJournalTemplate> builder)
    {
        builder.ToTable("res_journal_template", "resources");
