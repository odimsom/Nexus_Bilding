...
public class ResLedgerEntryConfiguration : IEntityTypeConfiguration<ResLedgerEntry>
{
    public void Configure(EntityTypeBuilder<ResLedgerEntry> builder)
    {
        builder.ToTable("res_ledger_entry", "resources");
