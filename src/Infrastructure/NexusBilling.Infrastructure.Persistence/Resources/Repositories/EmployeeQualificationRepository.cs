...
public class EmployeeQualificationRepository(NexusBillingDbContext dbContext) : GenericRepository<EmployeeQualification>(dbContext), IEmployeeQualificationRepository
{
}
