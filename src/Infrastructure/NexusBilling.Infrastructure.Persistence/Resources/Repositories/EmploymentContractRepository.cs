...
public class EmploymentContractRepository(NexusBillingDbContext dbContext) : GenericRepository<EmploymentContract>(dbContext), IEmploymentContractRepository
{
}
