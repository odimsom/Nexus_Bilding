...
public class GroundsForTerminationRepository(NexusBillingDbContext dbContext) : GenericRepository<GroundsForTermination>(dbContext), IGroundsForTerminationRepository
{
}
