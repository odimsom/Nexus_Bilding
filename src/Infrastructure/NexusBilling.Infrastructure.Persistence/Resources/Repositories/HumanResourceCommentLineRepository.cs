...
public class HumanResourceCommentLineRepository(NexusBillingDbContext dbContext) : GenericRepository<HumanResourceCommentLine>(dbContext), IHumanResourceCommentLineRepository
{
}
