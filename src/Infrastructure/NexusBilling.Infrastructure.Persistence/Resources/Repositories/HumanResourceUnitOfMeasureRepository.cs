...
public class HumanResourceUnitOfMeasureRepository(NexusBillingDbContext dbContext) : GenericRepository<HumanResourceUnitOfMeasure>(dbContext), IHumanResourceUnitOfMeasureRepository
{
}
