...
public class JobJournalTemplateRepository(NexusBillingDbContext dbContext) : GenericRepository<JobJournalTemplate>(dbContext), IJobJournalTemplateRepository
{
}
