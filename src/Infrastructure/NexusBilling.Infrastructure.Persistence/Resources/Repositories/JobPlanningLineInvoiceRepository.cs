...
public class JobPlanningLineInvoiceRepository(NexusBillingDbContext dbContext) : GenericRepository<JobPlanningLineInvoice>(dbContext), IJobPlanningLineInvoiceRepository
{
}
