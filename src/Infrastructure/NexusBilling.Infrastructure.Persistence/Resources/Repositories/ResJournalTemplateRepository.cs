...
public class ResJournalTemplateRepository(NexusBillingDbContext dbContext) : GenericRepository<ResJournalTemplate>(dbContext), IResJournalTemplateRepository
{
}
