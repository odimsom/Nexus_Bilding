...
public class ResourceUnitOfMeasureRepository(NexusBillingDbContext dbContext) : GenericRepository<ResourceUnitOfMeasure>(dbContext), IResourceUnitOfMeasureRepository
{
}
