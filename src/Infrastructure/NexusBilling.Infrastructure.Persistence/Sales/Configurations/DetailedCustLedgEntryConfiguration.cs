...
public class DetailedCustLedgEntryConfiguration : IEntityTypeConfiguration<DetailedCustLedgEntry>
{
    public void Configure(EntityTypeBuilder<DetailedCustLedgEntry> builder)
    {
        builder.ToTable("detailed_cust_ledg_entry", "sales");
        builder.HasKey(x => x.Id);
        builder.Property(x => x.TenantId).HasConversion(v => v.Value, v => TenantIdentifier.Create(v)).HasColumnName("tenant_id").IsRequired();
        builder.Property(x => x.EntryNo).HasColumnName("entry_no");
        builder.Property(x => x.CustLedgerEntryNo).HasColumnName("cust_ledger_entry_no");
        ...
        builder.Property(x => x.AppliedCustLedgerEntryNo).HasColumnName("applied_cust_ledger_entry_no");
