...
public class ReturnReceiptHeaderConfiguration : IEntityTypeConfiguration<ReturnReceiptHeader>
{
    public void Configure(EntityTypeBuilder<ReturnReceiptHeader> builder)
    {
        builder.ToTable("return_receipt_header", "sales");
        ...
        builder.Property(x => x.WarehouseHandlingTime).HasColumnName("warehouse_handling_time");
        builder.Property(x => x.LateOrderShipping).HasColumnName("late_order_shipping");
