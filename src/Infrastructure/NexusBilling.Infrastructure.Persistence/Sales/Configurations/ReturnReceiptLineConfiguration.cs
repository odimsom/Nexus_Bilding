...
public class ReturnReceiptLineConfiguration : IEntityTypeConfiguration<ReturnReceiptLine>
{
    public void Configure(EntityTypeBuilder<ReturnReceiptLine> builder)
    {
        builder.ToTable("return_receipt_line", "sales");
        ...
        builder.Property(x => x.ReturnOrderLineNo).HasColumnName("return_order_line_no");
