...
public class SalesCommentLineArchiveConfiguration : IEntityTypeConfiguration<SalesCommentLineArchive>
{
    public void Configure(EntityTypeBuilder<SalesCommentLineArchive> builder)
    {
        builder.ToTable("sales_comment_line_archive", "sales");
