...
public class SalesCrMemoHeaderConfiguration : IEntityTypeConfiguration<SalesCrMemoHeader>
{
    public void Configure(EntityTypeBuilder<SalesCrMemoHeader> builder)
    {
        builder.ToTable("sales_cr_memo_header", "sales");
        ...
        builder.Property(x => x.GetReturnReceiptUsed).HasColumnName("get_return_receipt_used");
    }
}
