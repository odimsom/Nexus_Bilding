...
public class SalesCrMemoLineConfiguration : IEntityTypeConfiguration<SalesCrMemoLine>
{
    public void Configure(EntityTypeBuilder<SalesCrMemoLine> builder)
    {
        builder.ToTable("sales_cr_memo_line", "sales");
