...
public class SalesInvoiceHeaderConfiguration : IEntityTypeConfiguration<SalesInvoiceHeader>
{
    public void Configure(EntityTypeBuilder<SalesInvoiceHeader> builder)
    {
        builder.ToTable("sales_invoice_header", "sales");
        ...
        builder.Property(x => x.PaymentServiceSetId).HasColumnName("payment_service_set_id");
        builder.Property(x => x.DocumentExchangeIdentifier).HasColumnName("document_exchange_identifier");
        builder.Property(x => x.DocumentExchangeStatus).HasColumnName("document_exchange_status");
        builder.Property(x => x.DocExchOriginalIdentifier).HasColumnName("doc_exch_original_identifier");
        builder.Property(x => x.CoupledToCrm).HasColumnName("coupled_to_crm");
