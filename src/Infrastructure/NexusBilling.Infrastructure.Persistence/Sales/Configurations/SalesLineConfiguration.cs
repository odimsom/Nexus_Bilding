...
public class SalesLineConfiguration : IEntityTypeConfiguration<SalesLine>
{
    ...
    {
        builder.ToTable("sales_line", "sales");
        ...
        builder.Property(x => x.QtyToShip).HasColumnName("qty_to_ship");
        ...
        builder.Property(x => x.QtyShippedNotInvoiced).HasColumnName("qty_shipped_not_invoiced");
        builder.Property(x => x.ShippedNotInvoiced).HasColumnName("shipped_not_invoiced");
        builder.Property(x => x.QuantityShipped).HasColumnName("quantity_shipped");
        ...
        builder.Property(x => x.ShippedNotInvoicedLcy).HasColumnName("shipped_not_invoiced_lcy");
