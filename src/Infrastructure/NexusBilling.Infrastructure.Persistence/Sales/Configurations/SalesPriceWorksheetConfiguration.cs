...
public class SalesPriceWorksheetConfiguration : IEntityTypeConfiguration<SalesPriceWorksheet>
{
    public void Configure(EntityTypeBuilder<SalesPriceWorksheet> builder)
    {
        builder.ToTable("sales_price_worksheet", "sales");
        ...
        builder.Property(x => x.CurrentUnitPrice).HasColumnName("current_unit_price").HasPrecision(18, 5);
        builder.Property(x => x.NewUnitPrice).HasColumnName("new_unit_price").HasPrecision(18, 5);
        ...
        builder.Property(x => x.SalesDescription).HasColumnName("sales_description");
