...
public class WorkflowStepArgumentConfiguration : IEntityTypeConfiguration<WorkflowStepArgument>
{
    public void Configure(EntityTypeBuilder<WorkflowStepArgument> builder)
    {
        builder.ToTable("workflow_step_argument", "security");
