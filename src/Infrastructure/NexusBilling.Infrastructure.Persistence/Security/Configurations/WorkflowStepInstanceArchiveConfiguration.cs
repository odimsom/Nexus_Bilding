...
public class WorkflowStepInstanceArchiveConfiguration : IEntityTypeConfiguration<WorkflowStepInstanceArchive>
{
    public void Configure(EntityTypeBuilder<WorkflowStepInstanceArchive> builder)
    {
        builder.ToTable("workflow_step_instance_archive", "security");
